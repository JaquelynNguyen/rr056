...
@Autonomous(name = "PIDEncoderTest")
@Disabled
public class PIDEncoderTest extends LinearOpMode {
    //Time
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && !isStopRequested()) {
                if(gamepad1.a) {
                    drivetrain.setTarget((int)(24.0 * COUNTS_PER_INCH));
                    while((drivetrain.positionDifference() > 20) && opModeIsActive()) {
                        drivetrain.update();
